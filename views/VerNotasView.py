...
################################################################################
## Form generated from reading UI file 'VerLibretaXXmwCf.ui'
##
...
class Ui_VerNotas(object):
    def setupUi(self, VerNotas):
        ...
        self.label_31.setGeometry(QRect(20, 130, 81, 16))
        font = QFont()
...
"")
    ...
    def retranslateUi(self, VerNotas):
        ...
        self.label_31.setText(QCoreApplication.translate("VerNotas", u"Nota Final", None))
